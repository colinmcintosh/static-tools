...
BIND9_SOURCE_SIG_URL := https://downloads.isc.org/isc/bind9/$(BIND9_VERSION)/bind-$(BIND9_VERSION).tar.xz.asc
BIND9_SOURCE_KEY := bind

# Prefix libraries statically linked into this artifact (SBOM).
# BIND 9.16 has no nghttp2 support (DoH arrived in 9.17).
SBOM_LIBS := openssl libuv
